  ...
  async function mountSvelteComponentVariant(variantNum) {
    ...
    try {
      ...
      const modulePath =
        ...
        extension;
      const moduleUrl =
        resolveComponentModuleUrl(manifest, modulePath) + "?t=" + Date.now();
        ...
        case "variant_progress":
          if (msg.id === currentSessionId) {
            ...
            if (
              ...
              (msg.previewMode === "source" || !msg.previewMode) &&
              (msg.previewFile || msg.file)
            ) {
              ...
              setTimeout(() => {
                ...
                if (
                  msg.publicationKind !== "params" &&
                  arrivedVariants >= targetArrived
                )
                  return;
