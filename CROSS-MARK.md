...
Generated by `scripts/generate-mark-preview.cjs` (see [One-time setup](#one-time-setup)) — always in sync with `public/`, since `generate-kothom-mark.cjs` rebuilds it automatically.
...
#### 5. Solid Monochrome (`public/kothom-mark-monochrome-light.svg` & `public/kothom-mark-monochrome-dark.svg`)
...
#### 6. Favicon & Social Profile Avatar (`public/favicon.svg` & `public/kothom-social-avatar.svg`)
